...
export class CrucialHint {
  ...
  private static crucialHints: CrucialHint[] = [
    ...
    CrucialHint.create("Leipzig", "Ort/Stadt", "/assets/images/crucial-hint/leipzig.jpg", ["Ich belegte 2021 den 8. Platz der Großstädte Deutschlands.", "Ich bin die einwohnerreichste Stadt Sachsens.", "Ich bin ein traditioneller Messestandort.", "Ich bin das Zuhause von Rasenballsport."]),
    ...
    CrucialHint.create("Spreewald", "Ort", "/assets/images/crucial-hint/spreewald.jpg", ["Ich bin eine historische Kulturlandschaft in Brandenburg.", "Ich habe knapp 300 Kilometer klassifizierte Wasserstraßen.", "Ich bin ein Erholungs- und Urlaubsgebiet und bekannt durch Kahnfahrten und Kanu-Gruppen.", "Der Hauptfluss meiner Natur- und Moorlandschaft ist mein Namensgeber."]),
    ...
    CrucialHint.create("Dresden", "Ort/Stadt","/assets/images/crucial-hint/dresden.jpg", ["Ich bin eine der 500k Städte Deutschlands.", "Ich wurde 1206 das erste mal urkundlich erwähnt.", "Jährlich findet hier einer der ältesten Weihnachtsmärkte Deutschlands statt.", "Ich bin die Landeshauptstadt Sachsens."]),
    ...
    CrucialHint.create("Sydney", "Ort/Stadt", "/assets/images/crucial-hint/sydney.jpg", ["Ich wurde 1788 gegründet.", "Ich habe rund 4,7 Millionen Einwohner.", "Mein Opera House ist weltbekannt.", "Ich bin die größte Stadt Australiens."]),
    ...
    CrucialHint.create("New York", "Ort/Stadt", "/assets/images/crucial-hint/new-york.jpg", ["Ich habe rund 8,8 Millionen Einwohner.", "1524 fanden die ersten Entdeckungsreisen zu mir statt. 1624 wurde ich durch 30 niederländische Familien kolonisiert.", "2001 war ich Ziel eines großen Terroranschlags.", "Bei mir findet man die Freiheitsstatue und das Empire State Building."]),
    ...
    CrucialHint.create("Cottbus", "Ort/Stadt", "/assets/images/crucial-hint/cottbus.jpg", ["Ich bin eine kreisfreie Universitätsstadt in Brandenburg.", "Ich habe knapp 100.000 Einwohner.", "Ich wurde 1156 das erste mal urkundlich erwähnt.", "Mein bekanntester Fußballverein spielt i, Stadion der Freundschaft und heißt FC Energie ..."]),
    // https://cdn.pixabay.com/photo/2021/06/19/18/08/prague-castle-6349140_1280.jpg
    CrucialHint.create("Prag", "Ort/Stadt", "/assets/images/crucial-hint/prag.jpg", ["Ich habe ü+ber 1,3 Millionen Einwohner.", "Durch mich fließt die Moldau.", "Meine Altstadt ist seit 1992 UNESCO Kulturerbe.", "Ich bin die Hauptstadt der Tschechischen Republik."]),
